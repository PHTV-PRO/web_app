        ...
        <div className='grid gap-4 grid-cols-3'>
            <div className="flex items-center  my-6 bg-gray-100 p-6 rounded-md shadow-md">
                ...
                <div>
                    ...
                    <h4 className="text-gray-700 text-2xl font-bold">{dataChartOfEmployerFromAdminById?.jobs_has_been_created || dataChartOfEmployer?.jobs_has_been_created}</h4>
                </div>
            </div>
            <div className="flex items-center  my-6 bg-gray-100 p-6 rounded-md shadow-md">
            ...
            <div className="flex items-center  my-6 bg-gray-100 p-6 rounded-md shadow-md">
                ...
                <div>
                    ...
                    <h4 className="text-gray-700 text-2xl font-bold">{dataChartOfEmployerFromAdminById?.total_applicated_by_month || dataChartOfEmployer?.total_applicated_by_month}</h4>
