...
const SummaryDetail = (props) => {
    ...
    const dataChartOfEmployer = props.dataChartOfEmployer
    return <div className="mb-10">
        ...
        {userLogin?.role === "EMPLOYER" &&
            <div className='grid gap-4 grid-cols-3'>
                <div className="flex items-center  bg-gray-100 p-6 rounded-md shadow-md">
                    <div className=" bg-purple-400 mr-4 px-4 py-3 rounded-2xl text-2xl text-white"><FileProtectOutlined /></div>
                    <div>
                        <h1 className="text-base text-gray-400 font-bold">Job Created</h1>
                ...
                <div className="flex items-center bg-gray-100 p-6 rounded-md shadow-md">
                    <div className="bg-red-400 mr-4 px-4 py-3 rounded-2xl text-2xl text-white"><CreditCardFilled /></div>
                    <div>
                        <h1 className="text-base text-gray-400 font-bold">Overall Payment</h1>
                ...
                <div className="flex items-center  bg-gray-100 p-6 rounded-md shadow-md">
                    <div className="bg-green-400 mr-4 px-4 py-3 rounded-2xl text-2xl text-white"><BookOutlined /></div>
                    <div>
